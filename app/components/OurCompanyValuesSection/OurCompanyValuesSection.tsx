...
const OurCompanyValuesSection: React.FC = () => (
          ...
          >
              ...
              <div className="card card-xl card-gray __hover-blue __radius-tr-70 __radius-bl-70 h-100">
                <div className="card-body card-pad-40">
                  <div className='card-icn-wrap icn-bg-blue icn-55 __radius-tl-150 __radius-tr-150 __radius-bl-150'>
                    <Image src="/assets/images/company-values-innovation-icon.svg" alt="Innovation Icon" width={55} height={55} />
                  </div>
            ...
            <SwiperSlide className='h-auto'>
              <div className="card card-xl card-gray __hover-blue __radius-tr-70 __radius-bl-70 h-100">
                <div className="card-body card-pad-40">
                  <div className='card-icn-wrap icn-bg-blue icn-55 __radius-tl-150 __radius-tr-150 __radius-bl-150'>
                    <Image src="/assets/images/company-values-collaboration-icon.svg" alt="Collaboration Icon" width={55} height={55} />
                  </div>
            ...
            <SwiperSlide className='h-auto'>
              <div className="card card-xl card-gray __hover-blue __radius-tr-70 __radius-bl-70 h-100">
                <div className="card-body card-pad-40">
                  <div className='card-icn-wrap icn-bg-blue icn-55 __radius-tl-150 __radius-tr-150 __radius-bl-150'>
                    <Image src="/assets/images/company-values-integrity-icon.svg" alt="Integrity Icon" width={55} height={55} />
                  </div>
