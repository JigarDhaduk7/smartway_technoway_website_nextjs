    ...
    <div className='container'>
      <div className='row align-items-center justify-content-between' data-aos="fade-up">
        ...
        <div className='col-lg-5 col-xl-4'>
          <p className="peragraph-style-1">Discover how businesses across industries have achieved growth and efficiency with our IT solutions. These success stories highlight the real impact</p>
        </div>
      </div>
                ...
                <div className="card card-xl card-gray __hover-blue __radius-tl-50 __radius-br-50 h-100">
                  <div className="card-body card-pad-30">
                    ...
                    <p className="peragraph-style-2 mb-4">
                      Nexus transformed our IT infrastructure and made our operations far more efficient.
                    </p>
