  ...
  useEffect(() => {
    const fetchProjects = async () => {
      try {
        ...
        const allProjects = response.data?.filter((p: Project) => p.isPublished) || [];
                ...
                <div data-aos="fade-up">
                  ...
                  <div className='card card-xl __hover-blue __radius-tr-70 __radius-bl-70 mt-3'>
                    <div className='card-body card-pad-40'>
                      ...
                      <div className='d-inline-block'>
                        <Link href={`/projects/${project.slug}`} className='btn btn-primary d-flex align-items-center'>Learn more <i className="far fa-long-arrow-right font-18 ms-2"></i></Link>
                      </div>
                    </div>
                  </div>
                </div>
