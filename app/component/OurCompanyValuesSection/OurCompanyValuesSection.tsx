            ...
            <SwiperSlide className='h-auto'>
              <div className="card card-xl card-gray __hover-blue __radius-tr-70 __radius-bl-70 h-100">
                <div className="card-body card-pad-40">
                  ...
                  <p className='peragraph-style-1'>We constantly evolve, explore, and adopt emerging technologies to stay ahead of the curve.</p>
                </div>
              </div>
            </SwiperSlide>
            ...
            <SwiperSlide className='h-auto'>
              <div className="card card-xl card-gray __hover-blue __radius-tr-70 __radius-bl-70 h-100">
                <div className="card-body card-pad-40">
                  ...
                  <p className='peragraph-style-1'>Integrity	Every interaction is rooted in honesty, transparency, and ethical excellence.</p>
                </div>
              </div>
            </SwiperSlide>
            ...
            <SwiperSlide className='h-auto'>
              <div className="card card-xl card-gray __hover-blue __radius-tr-70 __radius-bl-70 h-100">
                <div className="card-body card-pad-40">
                  ...
                  <h2 className='heading-lg'>Impact</h2>
                  <p className='peragraph-style-1'>Our success is measured by the real value we deliver to our clients and communities.</p>
                </div>
              </div>
            </SwiperSlide>
            ...
            <SwiperSlide className='h-auto'>
              <div className="card card-xl card-gray __hover-blue __radius-tr-70 __radius-bl-70 h-100">
                <div className="card-body card-pad-40">
                  ...
                  <p className='peragraph-style-1'>We work as an extension of your team, co-creating solutions that drive long-term success.</p>
                </div>
              </div>
            </SwiperSlide>
            ...
            <SwiperSlide className='h-auto'>
              <div className="card card-xl card-gray __hover-blue __radius-tr-70 __radius-bl-70 h-100">
                <div className="card-body card-pad-40">
                  ...
                  <h2 className='heading-lg'>Excellence</h2>
                  <p className='peragraph-style-1'>Quality isn't an option — it's our standard in every line of code, design, and decision.</p>
                </div>
              </div>
            </SwiperSlide>
